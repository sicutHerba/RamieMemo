              ...
              <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-24 pt-6 pb-12 max-w-5xl">
                ...
                <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
                  ...
                  <div className="bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">GitHub Issue</h3>
                    <p className="text-sm text-gray-600 mb-3">在仓库中创建 Issue</p>
                    <a 
                      href="https://github.com/sicutHerba/RamieMemo/issues"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center text-sm text-gray-700 hover:text-black transition-colors font-medium"
                    >
